...
{ 
	...
	SYSCTRLx->PORTCTRL0  &=  ~TIM10_GATE_MASK;					//清除SYSCON_PORTCR的 TIM10_GATE_SEL[1:0]  (Timer10 门控信号来源选择)
	SYSCTRLx->PORTCTRL0  |=  SYSCTRL_TIM10_GATE;					//设置SYSCON_PORTCR的 TIM10_GATE_SEL[1:0] 为SYSCTRL_TIM10_GATE模式
}
