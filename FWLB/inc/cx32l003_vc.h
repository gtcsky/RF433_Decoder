...
#define V25DIV_1P4     ((uint32_t)0x00000000<<4)
#define V25DIV_2P4     ((uint32_t)0x00000001<<4)
#define V25DIV_3P4     ((uint32_t)0x00000002<<4)
#define V25DIV_4P4     ((uint32_t)0x00000003<<4)
#define VC_V25DIV_SEL(V25DIV) ((V25DIV>=0x00000000)||\
                               ((NIN&0xffffcfff) ==0x00000000))
